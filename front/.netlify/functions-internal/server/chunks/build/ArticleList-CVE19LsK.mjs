import { I as IS_DESKTOP, t as translationsService, a as __nuxt_component_4, b as apiService, n as notificationsService, C as ChaptersApi } from './responsive-utils-BS0Y8toX.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  let _temp0;
  _push(`<article${ssrRenderAttrs(mergeProps({ class: "article" }, _attrs))} data-v-547e38d6><a${ssrRenderAttr("href", $options.articleUrl)} class="article__link" data-v-547e38d6><h2 class="article__title" data-v-547e38d6>${ssrInterpolate($options.articleTitle)}</h2></a><div class="article__content" data-v-547e38d6>`);
  if ($props.lazy) {
    _push(`<img${ssrRenderAttrs(_temp0 = mergeProps({
      alt: $options.articleTitle,
      rel: "noreferrer",
      class: "article__image"
    }, ssrGetDirectiveProps(_ctx, _directive_lazy, $props.article.imgLink)))} data-v-547e38d6>${"textContent" in _temp0 ? ssrInterpolate(_temp0.textContent) : (_a = _temp0.innerHTML) != null ? _a : ""}`);
  } else {
    _push(`<img${ssrRenderAttr("src", $props.article.imgLink)}${ssrRenderAttr("alt", $options.articleTitle)} class="article__image important" width="200" data-v-547e38d6>`);
  }
  _push(`</div><footer class="article__footer" data-v-547e38d6>`);
  if ($props.adminMode) {
    _push(`<!--[--><form data-v-547e38d6>`);
    ...
    _push(`<input${ssrRenderAttr("value", $data.chapterToRepair)} class="chapter-input" data-v-547e38d6></form>`);
    _push(ssrRenderComponent(_component_app_button, {
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-547e38d6"]]);
const isCecile = () => {
  return false;
};
...
//# sourceMappingURL=ArticleList-CVE19LsK.mjs.map
