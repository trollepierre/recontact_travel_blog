...
import { a as __nuxt_component_4, _ as __nuxt_component_0, C as ChaptersApi, t as translationsService, l as logger, b as apiService, I as IS_DESKTOP, s as screenWidth, c as IS_TABLET, n as notificationsService } from './responsive-utils-Cna-zfBt.mjs';
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$6], ["__scopeId", "data-v-2126b374"]]);
const CommentsApi = {
  fetch(id) {
...
const CommentForm = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$5], ["__scopeId", "data-v-a92bafd5"]]);
const _sfc_main$5 = {
  name: "CommentCard",
...
const CommentCard = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-9140e6db"]]);
const _sfc_main$4 = {
  name: "CommentList",
...
const CommentList = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-5d973cf6"]]);
const _sfc_main$3 = {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  let _temp0, _temp1;
  _push(`<article${ssrRenderAttrs(mergeProps({ class: "photo" }, _attrs))} data-v-8e4c369d><div class="photo__content" data-v-8e4c369d><img${ssrRenderAttrs(_temp0 = mergeProps({
    class: "img",
    rel: "noreferrer",
    alt: $options.image
  }, ssrGetDirectiveProps(_ctx, _directive_lazy, $options.imgLink)))} data-v-8e4c369d>${"textContent" in _temp0 ? ssrInterpolate(_temp0.textContent) : (_a = _temp0.innerHTML) != null ? _a : ""}<div${ssrRenderAttrs(_temp1 = ssrGetDirectiveProps(_ctx, _directive_lazy, $options.imgLink, "background-image"))} data-v-8e4c369d>${"textContent" in _temp1 ? ssrInterpolate(_temp1.textContent) : (_b = _temp1.innerHTML) != null ? _b : ""}</div></div></article>`);
}
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-8e4c369d"]]);
const PhotosApi = {
  fetch(id) {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_app_button = __nuxt_component_4;
  _push(`<main${ssrRenderAttrs(_attrs)} data-v-421eb146>`);
  _push(ssrRenderComponent(_component_app_header, null, null, _parent));
  _push(`<div class="page" data-v-421eb146><section class="article-page" data-v-421eb146><h1 class="article-page__title" data-v-421eb146>${ssrInterpolate($data.title || _ctx.$t("title"))}</h1><ul class="chapter__list" data-v-421eb146><!--[-->`);
  ssrRenderList($data.chapters, (chapter, index) => {
    _push(`<li class="chapter__item" data-v-421eb146>`);
  ...
  if (!$options.isEmpty($data.photos)) {
    _push(`<section data-v-421eb146><h2 data-v-421eb146>${ssrInterpolate(_ctx.$t("hereTheGallery"))}</h2><ul class="photo-gallery__list" data-v-421eb146><!--[-->`);
    ssrRenderList($data.photos, (photo, index) => {
      _push(`<li class="photo__item" data-v-421eb146>`);
  ...
  _push(`<footer class="footer-article" data-v-421eb146>`);
  _push(ssrRenderComponent(_component_app_button, {
    class: "app-button",
    tag: "NuxtLink",
    to: "/",
  ...
  if ($options.previousArticleTo) {
    _push(ssrRenderComponent(_component_app_button, {
      class: "app-button",
      tag: "NuxtLink",
      to: $options.previousArticleTo,
      text: _ctx.$t("goToPreviousArticle")
    }, null, _parent));
  } else {
    _push(`<!---->`);
  }
  if ($options.nextArticleTo) {
    _push(ssrRenderComponent(_component_app_button, {
      class: "app-button",
      tag: "NuxtLink",
      to: $options.nextArticleTo,
...
const ArticlePage = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-421eb146"]]);
const _sfc_main = {
  __name: "[id]",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(ArticlePage, _attrs, null, _parent));
    };
  }
};
...
//# sourceMappingURL=_id_-CNAB6krt.mjs.map
