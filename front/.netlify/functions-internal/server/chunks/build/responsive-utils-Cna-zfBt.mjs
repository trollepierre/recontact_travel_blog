import { _ as __nuxt_component_0$1 } from './nuxt-link-DRv9H_7M.mjs';
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  } else if ($options.isAnchor) {
    _push(`<a${ssrRenderAttrs(mergeProps({
      href: $props.href,
      target: $props.target,
      rel: $props.rel,
      class: $props.hide ? "hidden" : "button"
    }, _attrs))} data-v-1ba2714f>${ssrInterpolate($props.text)}</a>`);
  } else {
    _push(`<button${ssrRenderAttrs(mergeProps({
      type: "button",
      class: $props.hide ? "hidden" : "button"
    }, _attrs))} data-v-1ba2714f>${ssrInterpolate($props.text)}</button>`);
  }
}
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-1ba2714f"]]);
const env = (key) => {
  {
    try {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-10f5e0bf><div class="container" data-v-10f5e0bf><a${ssrRenderAttr("title", _ctx.$t("home"))} class="logo" href="/" data-v-10f5e0bf><img${ssrRenderAttr("alt", _ctx.$t("logo"))} class="icon" width="38" height="38"${ssrRenderAttr("src", _imports_0)} data-v-10f5e0bf><span class="recontact" data-v-10f5e0bf>Recontact</span><span class="me" data-v-10f5e0bf>Me</span></a>`);
  if (_ctx.isArticlePage) {
    _push(`<nav aria-label="navigation" data-v-10f5e0bf><ul class="navigation" data-v-10f5e0bf><li class="article" data-v-10f5e0bf>`);
    ...
    _push(`</li><li class="article-text" data-v-10f5e0bf><p class="id" data-v-10f5e0bf> Article ${ssrInterpolate(_ctx.articleId)}</p></li><li class="article" data-v-10f5e0bf>`);
  ...
  _push(`<nav aria-label="navigation" data-v-10f5e0bf>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-10f5e0bf"]]);
...
//# sourceMappingURL=responsive-utils-Cna-zfBt.mjs.map
