...
const links$1 = { "home": "Home", "about": "About", "english": "English version", "french": "French version" };
const home$1 = { "title": "Welcome", "introduction": "This is an introduction in English." };
const about$1 = { "title": "About", "introduction": "This page is made to give you more informations." };
const en = {
  links: links$1,
  home: home$1,
  about: about$1
};
const links = { "home": "Accueil", "about": "À propos", "english": "Version Anglaise", "french": "Version Française" };
const home = { "title": "Bienvenue", "introduction": "Ceci est un texte d'introduction en Français." };
const about = { "title": "À propos", "introduction": "Cette page est faite pour vous donner plus d'informations." };
const fr = {
  links,
  home,
  about
};
const i18n_M6WuPocwmDZfR2LKAqoIP7SPPiCebMfT5sB7ls3Be_c = /* @__PURE__ */ defineNuxtPlugin(() => {
  const config = /* @__PURE__ */ useRuntimeConfig();
  const initialLocale = config.public.language || "fr";
  ...
  app.vueApp.use(i18n);
  app.provide("i18nPath", (link) => {
    const current = i18n.global.locale.value;
    const fallback = "fr";
    return current === fallback ? `/${link}` : `/${current}/${link}`;
  });
});
const getInLocalStorage = (key) => (void 0).localStorage.getItem(key);
const saveInLocalStorage = (key, value) => (void 0).localStorage.setItem(key, value);
const useAppStore = /* @__PURE__ */ defineStore("app", {
  ...
  actions: {
    initializeFromRuntimeConfig(language) {
    ...
    getThemeMode() {
      if (getInLocalStorage("theme")) {
        this.theme = getInLocalStorage("theme");
      } else if ((void 0).matchMedia && (void 0).matchMedia("(prefers-color-scheme: dark)").matches) {
        this.theme = "dark";
      }
    }
  }
});
const store_shim_PEdDn_uZRUQMrbE5oFeG_g9TobWZcU7wQL_zF9WkL8A = /* @__PURE__ */ defineNuxtPlugin(() => {
  const appStore = useAppStore();
  const config = /* @__PURE__ */ useRuntimeConfig();
  appStore.initializeFromRuntimeConfig(config.public.language);
...
const plugins = [
  ...
  store_shim_PEdDn_uZRUQMrbE5oFeG_g9TobWZcU7wQL_zF9WkL8A
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-DX6tTbwf.mjs').then((m) => m.default || m)),
  error: defineAsyncComponent(() => import('./error-BYyYwDWv.mjs').then((m) => m.default || m))
};
