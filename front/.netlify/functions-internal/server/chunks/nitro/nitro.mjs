...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "d10a2790-6e20-4adb-8db0-808fd56ee583",
  ...
  "public": {
    "apiBase": "https://recontact.herokuapp.com",
    "language": "fr",
    "mapboxToken": "pk.eyJ1IjoibGVzY29sc3ZlcnRzIiwiYSI6ImNraWcxeDRyMjBhcXYycW1xMmI4NW82bnIifQ.r9W_FGY8gVm5DRxdcmymDQ"
  }
};
const envOptions = {
  prefix: "NITRO_",
...
const _lazy_6dXPIT = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_6dXPIT, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_6dXPIT, lazy: true, middleware: false, method: undefined }
];
