export default {
  compile(model) {
    ...
    template += '<p>Il y a du nouveau du côté de <a href="https://www.recontact.me/#">Recontact Me</a>.</p>'
    template += '<p>'
    ...
    addedArticles.forEach(article => {
      template += `<a href="https://www.recontact.me/articles/${article.dropboxId}">${article.frTitle}</a>`
    })
    template += '</p>'
    return template
  },
